                           ...
                           <div class="carousel-caption  banner_po">
                              <div class="row">
                                 <div class="col-md-9">
                                       <div class="build_box">
                                          <h1>TUNITROC1</h1>
                                          <p>TUNITROC est un réseau social en Tunisie qui vous permet d’échanger et de
                                             prêter des biens et des services en toute sécurité, mais aussi de participer
                                             à des dons humanitaires.</p>
                                          <a class="read_more conatct_btn" href="about.html" role="button">plus d'info</a>
                                       </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="container">
                           <div class="carousel-caption banner_po">
                              <div class="row">
                                 <div class="col-md-9">
                                       <div class="build_box">
                                          <h1>COMMENCEZ A TROQUER</h1>
                                          <p>There are many variations of passages of Lorem Ipsum available, but the
                                             majority<br> There are many variations of passages of</p>
                                          <a class="read_more conatct_btn" href="contact.html"
                              ...
                              <div class="row">
                                 <div class="col-md-9">
                                       <div class="build_box">
                                          ...
                                          <p>There are many variations of passages of Lorem Ipsum available, but the
                                             majority<br> There are many variations of passages of</p>
                                          <a class="read_more conatct_btn" href="contact.html" role="button">ajoutez un
                                             produit</a>
                                       </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="col-md-4">
                                       <div class="project">
                                          <div class="project_img">
                                             <figure><img style="height:636px;object-fit:cover;" src="../images/project_img.jpg" alt="#"/></figure>
                                          </div>
                                          <div id="pro_ho" class="project_text">
                                             <h3>beauté et bien etre<br> </h3>
                                             <p>maquillage,coiffure,soins,massage,relaxation...</p>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="project">
                                          <div class="project_img">
                                             <figure><img style="height:636px;object-fit:cover;" src="../images/project_img1.jpg" alt="#"/></figure>
                                          </div>
                                          <div id="pro_ho" class="project_text">
                                             <h3>informatique<br> </h3>
                                             <p>assistance informatique,jeux video,matériel,appareil photo...</p>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="project">
                                          <div class="project_img">
                                             <figure><img style="height:636px;object-fit:cover;" src="../images/project_img2.jpg" alt="#"/></figure>
                                          </div>
                                          <div id="pro_ho" class="project_text">
         ...
         <div class="container_staff">
            <div class="row">
               ...
               <div class="col-md-4 col-sm-6">
                  <div class="staff">
                     <div class="man">
                        <i><img style="height: 200px;object-fit: cover;" src="../uploads/utilisateurs/oumaima.jpg" alt="#"/></i>
                     </div>
                     <div class="social_icon_main">
                        <h4>Oumaima amdouni</h4>
               ...
               <div class="col-md-4 col-sm-6">
                  <div class="staff">
                     <div class="man">
                        <i><img style="height: 200px;object-fit: cover;" src="../uploads/utilisateurs/lina.jpg" alt="#"/></i>
                     </div>
                     <div class="social_icon_main">
                        <h4>Lina Saadi</h4>
                        <ul class="social_icon_staff text_align_center  ">
               ...
               <div class="col-md-4 col-sm-6">
                  <div class="staff">
                     <div class="man">
                        <i><img style="height: 200px;object-fit: cover;" src="../uploads/utilisateurs/aziz.jpg" alt="#"/></i>
                     </div>
                     <div class="social_icon_main">
                        <h4>Aziz Bendeg</h4>
                        <ul class="social_icon_staff text_align_center  ">
               ...
               <div style="margin-top: 50px;" class="col-md-6 col-sm-6">
                  <div class="staff">
                     <div class="man">
                        <i><img style="height: 200px;object-fit: cover;"  src="../uploads/utilisateurs/mehdi.jpg" alt="#"/></i>
                     </div>
                     <div class="social_icon_main">
                        <h4>Mehdi Bchir</h4>
                        <ul class="social_icon_staff text_align_center  ">
               ...
               <div style="margin-top: 50px;" class="col-md-6 col-sm-6">
                  <div class="staff">
                     <div class="man">
                        <i><img style="height: 200px;object-fit: cover;"  src="../uploads/utilisateurs/moetez.jpg" alt="#"/></i>
                     </div>
                     <div class="social_icon_main">
                        <h4>Moetez Bechikh</h4>
                        <ul class="social_icon_staff text_align_center  ">
                           <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                           <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                           <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>

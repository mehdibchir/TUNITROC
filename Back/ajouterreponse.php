    ...
    <div id="right-panel" class="right-panel">
        ...
        <tr>
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                               <td style="color: gold; position: relative; top: 58px;"><label for="mail">Email</label></td>
                                               <td style="position: relative; left: 25px; top: 56px;"><input type="email" name="mail" id="mail" ></td>
                                           </tr>
                                           ...
                                           <tr>
                                               <td style="color: gold; position: relative; top: 110px;"><label for="description">Reponse</label></td>
                                               <td style="position: relative; left: 30px; top: 100px; "><textarea name="description" id="description"cols="50" rows="8" placeholder="Decrire votre reponse..."></textarea></td>
                                           </tr>

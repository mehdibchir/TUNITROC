<?PHP
    ...
    if (isset($_POST['nom']) and isset($_POST['prenom']) and isset($_POST['email']) and isset($_POST['password']) and isset($_POST['telephone']))
    {

	$target_dir = "../../Front/uploads/utilisateurs/";
	...
	// var_dump($target_file);
        ...
        $utilisateurs=new utilisateurs(0,$_POST['nom'],$_POST['prenom'],$_POST['email'],$hashed,$_POST['telephone'],"user",$pattern."_".$_FILES["imageUser"]["name"]);
